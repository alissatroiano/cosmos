...
let planetProto = {
    ...
    material: function(options) {
        ...
        if (options) for(var property in options)material[property] = options[property];
        return material;
    },
...
let createPlanet = function(options) {
    ...
    for(let textureProperty in options.surface.textures)planetProto.texture(surfaceMaterial, textureProperty, options.surface.textures[textureProperty]);
    // Load the Atmosphere's texture
    for(let textureProperty in options.atmosphere.textures)planetProto.texture(atmosphereMaterial, textureProperty, options.atmosphere.textures[textureProperty]);
    return planet;
};
...
//# sourceMappingURL=index.9415f697.js.map
