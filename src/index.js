...
const edgeColor = "#000";
const treeCrownColor = "#ffbd33";
const treeTrunkColor = "#000";
...
function renderMap(mapWidth, mapHeight) {
  ...
  if (config.planets) {
    ...
    planet1.position.x = arcCenterX * 1.3;
    scene.add(planet1);

    const planet2 = planet();
    planet2.position.y = arcCenterX * 1.9;
...
function hitDetection() {
  ...
  if (config.showHitZones) {
    playerPlanet.userData.hitZone1.position.x = playerHitZone1.x;
    playerPlanet.userData.hitZone1.position.y = playerHitZone1.y;

    playerPlanet.userData.hitZone2.position.x = playerHitZone2.x;
    playerPlanet.userData.hitZone2.position.y = playerHitZone2.y;
  }
